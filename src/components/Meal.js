...
const Meal = () => {
  ...
  return (
    <div className="max-w-[1520px] m-auto px-4 py-12">
      ...
      <div className="flex flex-col lg:flow-row justify-center">
        <div className="flex justify-center md:justify-center">
          ...
          <button
            onClick={() => fillerCategory('salad')}
            className="m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700"
          >
            Salad
          </button>
          <button
            onClick={() => fillerCategory('pizza')}
            className="m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700"
          >
            Pizza
          </button>
          <button
            onClick={() => fillerCategory('chicken')}
            className="m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700"
          >
            Chicken
          </button>
